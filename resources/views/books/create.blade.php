            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form action="{{ route('books.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="genre" id="genre" placeholder="genre" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    </div>
                    <div class="mb-4">
                        <label for="price" class="block text-gray-700">Preu:</label>
                        <input type="number" step="0.01" name="price" id="price" placeholder="price" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                    </div>
